...
public class HwVSimController extends StateMachine {
    ...
    public boolean dsFlowCfg(int repFlag, int threshold, int totalThreshold, int oper) {
        ...
        if (subId != 2) {
            subId = HwTelephonyManager.getDefault().getDefault4GSlotId();
    ...
    public boolean needBlockPin(int r5) {
        /*
        r4 = this;
        r3 = 1;
        r2 = 0;
        ...
        r0.<init>();
        r1 = "needBlockPin check for subId ";
        r0 = r0.append(r1);
        r0 = r0.append(r5);
        r0 = r0.toString();
        r4.logd(r0);
        ...
        r1 = ", mBlockPinTable = ";
        r0 = r0.append(r1);
        r1 = r4.mBlockPinTable;
        r1 = java.util.Arrays.toString(r1);
        r0 = r0.append(r1);
        r1 = ", mPinBlockedTable = ";
        r0 = r0.append(r1);
        r1 = r4.mPinBlockedTable;
        r1 = java.util.Arrays.toString(r1);
        r0 = r0.append(r1);
        r0 = r0.toString();
        r4.logd(r0);
    ...
    L_0x0056:
        r0 = com.android.internal.telephony.vsim.HwVSimModemAdapter.PHONE_COUNT;
    ...
    L_0x005f:
        return r2;
    L_0x0060:
        r0 = r4.mBlockPinTable;
        r0 = r0[r5];
        if (r0 != 0) goto L_0x0067;
    L_0x0066:
        return r2;
    L_0x0067:
        r0 = r4.mPinBlockedTable;
        r0[r5] = r3;
        r0 = new java.lang.StringBuilder;
        r0.<init>();
        r1 = "mPinBlockedTable = ";
        ...
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.vsim.HwVSimController.needBlockPin(int):boolean");
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isPinBlocked(int r4) {
        /*
        r3 = this;
        r2 = 0;
        r0 = new java.lang.StringBuilder;
        r0.<init>();
        r1 = "isPinBlocked, subId = ";
        r0 = r0.append(r1);
        r0 = r0.append(r4);
        r1 = ", mBlockPinFlag = ";
        r0 = r0.append(r1);
        ...
        r1 = ", mBlockPinTable = ";
        r0 = r0.append(r1);
        r1 = r3.mBlockPinTable;
        r1 = java.util.Arrays.toString(r1);
        r0 = r0.append(r1);
        r1 = ", mPinBlockedTable = ";
        r0 = r0.append(r1);
        r1 = r3.mPinBlockedTable;
        r1 = java.util.Arrays.toString(r1);
        r0 = r0.append(r1);
        r0 = r0.toString();
        r3.logd(r0);
    ...
    L_0x0052:
        return r2;
    L_0x0053:
        r0 = r3.mBlockPinTable;
        r0 = r0[r4];
        if (r0 != 0) goto L_0x005a;
    L_0x0059:
        return r2;
    L_0x005a:
        r0 = r3.mPinBlockedTable;
        r0 = r0[r4];
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.vsim.HwVSimController.isPinBlocked(int):boolean");
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isPinNeedBlock(int r4) {
        /*
        r3 = this;
        r2 = 0;
        r0 = new java.lang.StringBuilder;
        r0.<init>();
        r1 = "isPinNeedBlock, subId = ";
        r0 = r0.append(r1);
        r0 = r0.append(r4);
        r1 = ", mBlockPinFlag = ";
        r0 = r0.append(r1);
    ...
    L_0x0049:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.vsim.HwVSimController.isPinNeedBlock(int):boolean");
    }
    ...
    private void onAutoSwitchSimSlot() {
        ...
        if (HwAllInOneController.IS_HISI_DSDS_AUTO_SWITCH_4G_SLOT) {
            ...
            HwFrameworkFactory.getHwInnerTelephonyManager().setDefaultDataSlotId(HwTelephonyManager.getDefault().getDefault4GSlotId());
        }
    }

    private void onAutoSetAllowData() {
        if (HwVSimUtilsInner.isPlatformRealTripple()) {
            int allowDataSlotId = HwTelephonyManager.getDefault().getDefault4GSlotId();
            if (this.mPhones != null) {
                int len = this.mPhones.length;
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void updateSimCardTypes(int[] r5) {
        /*
        r4 = this;
        r3 = sSimCardTypesLock;
        monitor-enter(r3);
    ...
    L_0x0005:
        ...
        return;
    L_0x0007:
        r2 = r5.clone();	 Catch:{ all -> 0x0026 }
        r2 = (int[]) r2;	 Catch:{ all -> 0x0026 }
        r4.mSimCardTypes = r2;	 Catch:{ all -> 0x0026 }
        r2 = r4.isProcessInit();	 Catch:{ all -> 0x0026 }
        if (r2 == 0) goto L_0x0024;
    L_0x0015:
        r0 = r4.getHandler();	 Catch:{ all -> 0x0026 }
        if (r0 == 0) goto L_0x0024;
    L_0x001b:
        r2 = 77;
        r1 = r0.obtainMessage(r2);	 Catch:{ all -> 0x0026 }
    ...
    L_0x0026:
        ...
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.vsim.HwVSimController.updateSimCardTypes(int[]):void");
    }
