...
public class HwNetworkManagerImpl implements HwNetworkManager {
    ...
    private static class SaveThread extends Thread {
        ...
        public void run() {
            ...
            r8 = this;
            super.run();
            r4 = com.android.internal.telephony.HwNetworkManagerImpl.SaveThread.class;
            monitor-enter(r4);
            r3 = r8.mCr;	 Catch:{ all -> 0x0067 }
            if (r3 == 0) goto L_0x000e;
        L_0x000a:
            r3 = r8.mMcc;	 Catch:{ all -> 0x0067 }
            if (r3 != 0) goto L_0x0010;
        L_0x000e:
            monitor-exit(r4);
            return;
        L_0x0010:
            r3 = r8.mTimeZoneId;	 Catch:{ all -> 0x0067 }
            if (r3 == 0) goto L_0x000e;
        L_0x0014:
            r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0067 }
            r3.<init>();	 Catch:{ all -> 0x0067 }
            r5 = r8.mTimeZoneId;	 Catch:{ all -> 0x0067 }
            r3 = r3.append(r5);	 Catch:{ all -> 0x0067 }
            r5 = "||";
            r3 = r3.append(r5);	 Catch:{ all -> 0x0067 }
            r5 = r8.mMcc;	 Catch:{ all -> 0x0067 }
            r3 = r3.append(r5);	 Catch:{ all -> 0x0067 }
            r5 = "||";
            r3 = r3.append(r5);	 Catch:{ all -> 0x0067 }
            r6 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x0067 }
            r3 = r3.append(r6);	 Catch:{ all -> 0x0067 }
            r1 = r3.toString();	 Catch:{ all -> 0x0067 }
            r3 = r8.mCr;	 Catch:{ Exception -> 0x0064 }
            r5 = "nitz_timezone_info";
            android.provider.Settings.System.putString(r3, r5, r1);	 Catch:{ Exception -> 0x0064 }
            r3 = r8.mCr;	 Catch:{ Exception -> 0x0064 }
            r5 = "keyguard_default_time_zone";
            r2 = android.provider.Settings.System.getString(r3, r5);	 Catch:{ Exception -> 0x0064 }
            if (r2 == 0) goto L_0x0058;
        L_0x0052:
            r3 = r2.length();	 Catch:{ Exception -> 0x0064 }
            if (r3 != 0) goto L_0x0062;
        L_0x0058:
            r3 = r8.mCr;	 Catch:{ Exception -> 0x0064 }
            r5 = "keyguard_default_time_zone";
            r6 = r8.mTimeZoneId;	 Catch:{ Exception -> 0x0064 }
            android.provider.Settings.System.putString(r3, r5, r6);	 Catch:{ Exception -> 0x0064 }
        L_0x0062:
            monitor-exit(r4);
            return;
        L_0x0064:
        ...
        L_0x0067:
            ...
            throw r3;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.HwNetworkManagerImpl.SaveThread.run():void");
        }
    }
