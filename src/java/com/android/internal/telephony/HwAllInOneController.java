    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_VOICE_CALL_ENDED /*113*/:
                ...
                if (!(SubscriptionController.getInstance().getSubState(index.intValue() == 0 ? 1 : 0) == 1 || SubscriptionController.getInstance().getSubState(index.intValue()) != 1 || index.intValue() == HwTelephonyManager.getDefault().getDefault4GSlotId())) {
                    setDefault4GSlot(index.intValue());
                }
                if (index.intValue() == 1 && SubscriptionController.getInstance().getSubState(index.intValue()) == 1 && HwTelephonyManager.getDefault().isDataConnectivityDisabled(1, "disable-sub")) {
            ...
            case EVENT_FAST_SWITCH_SIM_SLOT_DONE /*114*/:
                ...
                if (ar == null || ar.exception != null) {
                    ...
                    HwFrameworkFactory.getHwInnerTelephonyManager().updateCrurrentPhone(index.intValue());
                    int oldSlotId = HwTelephonyManager.getDefault().getDefault4GSlotId();
                    setUserSwitchDualCardSlots(index.intValue());
                    Intent intent = new Intent("com.huawei.action.ACTION_HW_SWITCH_SLOT_DONE");
                    intent.putExtra(IF_NEED_SET_RADIO_CAP, oldSlotId == index.intValue() ? 1 : 0);
...
//        switch (-getcom-android-internal-telephony-HwAllInOneController$SubCarrierTypeSwitchesValues()[this.subCarrierTypeArray[sub].ordinal()]) {
        switch (this.subCarrierTypeArray[sub]) {
            case 1:
...
//        switch (-getcom-android-internal-telephony-HwAllInOneController$SubCarrierTypeSwitchesValues()[this.subCarrierTypeArray[sub].ordinal()]) {
    ...
    private void setNetworkTypeToDB(int r6, int r7) {
        /*
        r5 = this;
        r3 = 1;
        r1 = r5.getUserSwitchDualCardSlots();	 Catch:{ Exception -> 0x0077 }
        r2 = 9;
        r2 = com.android.internal.telephony.HwModemCapability.isCapabilitySupport(r2);	 Catch:{ Exception -> 0x0077 }
        if (r2 == 0) goto L_0x0043;
    L_0x000d:
        r2 = r5.mContext;	 Catch:{ Exception -> 0x0077 }
        r2 = r2.getContentResolver();	 Catch:{ Exception -> 0x0077 }
        r3 = "preferred_network_mode";
        android.telephony.TelephonyManager.putIntAtIndex(r2, r3, r6, r7);	 Catch:{ Exception -> 0x0077 }
    L_0x0019:
        r2 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0077 }
        r2.<init>();	 Catch:{ Exception -> 0x0077 }
        r3 = "setNetworkTypeToDB id = ";
        r2 = r2.append(r3);	 Catch:{ Exception -> 0x0077 }
        r2 = r2.append(r6);	 Catch:{ Exception -> 0x0077 }
        r3 = ", mode = ";
        r2 = r2.append(r3);	 Catch:{ Exception -> 0x0077 }
        r2 = r2.append(r7);	 Catch:{ Exception -> 0x0077 }
        r3 = " to database success!";
        r2 = r2.append(r3);	 Catch:{ Exception -> 0x0077 }
        r2 = r2.toString();	 Catch:{ Exception -> 0x0077 }
        r5.logd(r2);	 Catch:{ Exception -> 0x0077 }
    L_0x0042:
        return;
    L_0x0043:
        r2 = IS_DUAL_4G_SUPPORTED;	 Catch:{ Exception -> 0x0077 }
        if (r2 == 0) goto L_0x00a6;
    L_0x0047:
        r2 = SIM_NUM;	 Catch:{ Exception -> 0x0077 }
    ...
    L_0x004b:
        ...
        r4 = "preferred_network_mode";
        r3 = r3.append(r4);	 Catch:{ Exception -> 0x0077 }
        r3 = r3.append(r6);	 Catch:{ Exception -> 0x0077 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0077 }
        android.provider.Settings.Global.putInt(r2, r3, r7);	 Catch:{ Exception -> 0x0077 }
    ...
    L_0x0077:
        ...
        r2.<init>();
        r3 = "setNetworkTypeToDB Exception = ";
        r2 = r2.append(r3);
        r2 = r2.append(r0);
        r3 = ",phoneId:";
        r2 = r2.append(r3);
    ...
    L_0x00ac:
        ...
        goto L_0x0019;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.HwAllInOneController.setNetworkTypeToDB(int, int):void");
    }
    ...
    private boolean judgeDefalt4GSlotForMDM() {
        ...
        if (HwTelephonyManager.getDefault().isDataConnectivityDisabled(1, "disable-data") && isCardPresent(0) && isCardPresent(1) && isSub0Active) {
            this.default4GSlot = 0;
            return true;
        } else if (!HwTelephonyManager.getDefault().isDataConnectivityDisabled(1, "disable-sub") || !isCardPresent(0)) {
            return false;
        } else {
            this.default4GSlot = 0;
            return true;
