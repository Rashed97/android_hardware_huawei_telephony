...
public interface IHwTelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwTelephony {
        ...
        static final int TRANSACTION_isSecondaryCardGsmOnly = 101;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 32:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setDefault4GSlotId /*33*/:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_isSetDefault4GSlotIdEnabled /*34*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isSetDefault4GSlotIdEnabled();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case TRANSACTION_waitingSetDefault4GSlotDone /*35*/:
                    data.enforceInterface(DESCRIPTOR);
