...
public class HwDsdsController extends Handler {
    ...
    public void handleMessage(android.os.Message r7) {
        ...
        r3 = mLock;
        monitor-enter(r3);
        r1 = r6.getCiIndex(r7);	 Catch:{ all -> 0x0062 }
        r2 = r1.intValue();	 Catch:{ all -> 0x0062 }
        if (r2 < 0) goto L_0x0016;
    L_0x000d:
        r2 = r1.intValue();	 Catch:{ all -> 0x0062 }
        r4 = r6.mCis;	 Catch:{ all -> 0x0062 }
    ...
    L_0x0016:
        ...
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r4 = " received with event ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r4 = r7.what;	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        loge(r2);	 Catch:{ all -> 0x0062 }
        monitor-exit(r3);
        return;
    L_0x003c:
        r0 = r7.obj;	 Catch:{ all -> 0x0062 }
        r0 = (android.os.AsyncResult) r0;	 Catch:{ all -> 0x0062 }
        r2 = r7.what;	 Catch:{ all -> 0x0062 }
        switch(r2) {
            case 102: goto L_0x0065;
            case 103: goto L_0x0047;
            case 201: goto L_0x00e0;
            case 202: goto L_0x0080;
            case 203: goto L_0x00f9;
            case 204: goto L_0x00f9;
            case 301: goto L_0x012d;
            case 302: goto L_0x0157;
    ...
    L_0x0047:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_GET_BALONG_SIM_DONE on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        r6.onGetBalongSimDone(r0, r1);	 Catch:{ all -> 0x0062 }
        goto L_0x0045;
    L_0x0062:
        r2 = move-exception;
        monitor-exit(r3);
    ...
    L_0x0065:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_QUERY_CARD_TYPE_DONE on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        r6.onQueryCardTypeDone(r0, r1);	 Catch:{ all -> 0x0062 }
        goto L_0x0045;
    L_0x0080:
        r2 = r6.mAutoSetPowerupModemDone;	 Catch:{ all -> 0x0062 }
        if (r2 != 0) goto L_0x0045;
    L_0x0084:
        r2 = r6.mCis;	 Catch:{ all -> 0x0062 }
        r4 = r1.intValue();	 Catch:{ all -> 0x0062 }
        r2 = r2[r4];	 Catch:{ all -> 0x0062 }
        r2 = r2.getRadioState();	 Catch:{ all -> 0x0062 }
        r4 = com.android.internal.telephony.CommandsInterface.RadioState.RADIO_UNAVAILABLE;	 Catch:{ all -> 0x0062 }
        if (r2 == r4) goto L_0x0045;
    L_0x0094:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_HWDSDS_RADIO_STATE_CHANGED on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        ...
        r4 = r6.obtainMessage(r4, r1);	 Catch:{ all -> 0x0062 }
        r2.queryCardType(r4);	 Catch:{ all -> 0x0062 }
        r2 = r6.mCis;	 Catch:{ all -> 0x0062 }
        r4 = r1.intValue();	 Catch:{ all -> 0x0062 }
        r2 = r2[r4];	 Catch:{ all -> 0x0062 }
        r4 = 103; // 0x67 float:1.44E-43 double:5.1E-322;
        r4 = r6.obtainMessage(r4, r1);	 Catch:{ all -> 0x0062 }
        r2.getBalongSim(r4);	 Catch:{ all -> 0x0062 }
        r2 = r6.mCis;	 Catch:{ all -> 0x0062 }
        r4 = r1.intValue();	 Catch:{ all -> 0x0062 }
        r2 = r2[r4];	 Catch:{ all -> 0x0062 }
        r4 = 201; // 0xc9 float:2.82E-43 double:9.93E-322;
        r4 = r6.obtainMessage(r4, r1);	 Catch:{ all -> 0x0062 }
        r2.getIccCardStatus(r4);	 Catch:{ all -> 0x0062 }
        goto L_0x0045;
    L_0x00e0:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_HWDSDS_GET_ICC_STATUS_DONE on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
    ...
    L_0x00f9:
        ...
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received ";
        r4 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r7.what;	 Catch:{ all -> 0x0062 }
        r5 = 203; // 0xcb float:2.84E-43 double:1.003E-321;
        if (r2 != r5) goto L_0x0129;
    L_0x010b:
        r2 = "EVENT_HWDSDS_SET_ACTIVEMODE_DONE";
    L_0x010e:
        r2 = r4.append(r2);	 Catch:{ all -> 0x0062 }
        r4 = " on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        r6.handleActiveModeDoneOrTimeout(r7);	 Catch:{ all -> 0x0062 }
        goto L_0x0045;
    L_0x0129:
        r2 = "EVENT_HWDSDS_SET_ACTIVEMODE_TIMEOUT";
        goto L_0x010e;
    L_0x012d:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_HOTPLUG_CLOSE_MODEM_DONE on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        r2 = r6.mNumOfCloseModemSuccess;	 Catch:{ all -> 0x0062 }
        r2 = r2 + 1;
        r6.mNumOfCloseModemSuccess = r2;	 Catch:{ all -> 0x0062 }
        r2 = r6.mNumOfCloseModemSuccess;	 Catch:{ all -> 0x0062 }
        r4 = SIM_NUM;	 Catch:{ all -> 0x0062 }
        if (r2 != r4) goto L_0x0045;
    L_0x0150:
        r2 = 302; // 0x12e float:4.23E-43 double:1.49E-321;
        r6.processCloseModemDone(r2);	 Catch:{ all -> 0x0062 }
        goto L_0x0045;
    L_0x0157:
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0062 }
        r2.<init>();	 Catch:{ all -> 0x0062 }
        r4 = "Received EVENT_HOTPLUG_CLOSE_MODEM_TIMEOUT on index ";
        r2 = r2.append(r4);	 Catch:{ all -> 0x0062 }
        r2 = r2.append(r1);	 Catch:{ all -> 0x0062 }
        r2 = r2.toString();	 Catch:{ all -> 0x0062 }
        logd(r2);	 Catch:{ all -> 0x0062 }
        ...
        goto L_0x0045;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.HwDsdsController.handleMessage(android.os.Message):void");
    }
