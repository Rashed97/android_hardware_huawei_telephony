...
public class HwRILReferenceImpl extends Handler implements HwRILReference {
    ...
    private final BroadcastReceiver mCarrierConfigListener = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent != null && HwRILReferenceImpl.this.mHwRilReferenceInstanceId != null) {
                ...
                if (HwImsManager.isDualImsAvailable() || HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue() == subId) {
                    if ("android.telephony.action.CARRIER_CONFIG_CHANGED".equals(action)) {
                        int curSubForCarrier = intent.getIntExtra("subscription", 0);
                        if ((HwImsManager.isDualImsAvailable() || subId == curSubForCarrier) && curSubForCarrier == HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue()) {
                        ...
                        if (!(HwImsManager.isDualImsAvailable() || HwRILReferenceImpl.this.mRil == null)) {
                            HwRILReferenceImpl.this.handleUnsolicitedRadioStateChanged(HwRILReferenceImpl.this.mRil.getRadioState().isOn(), HwRILReferenceImpl.this.mContext);
                        }
                        ...
                        if (curSubId == HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue()) {
                            ...
                            if (HwRILReferenceImpl.FEATURE_VOLTE_DYN && HwRILReferenceImpl.this.mIsCarrierConfigLoaded) {
                                isSupportVolte = HwImsManager.isVolteEnabledByPlatform(context, HwRILReferenceImpl.this.mHwRilReferenceInstanceId.intValue());
    ...
    private void saveSwitchStatusToDB(boolean on) {
        ...
        if (this.mContext != null) {
            try {
                System.putInt(this.mContext.getContentResolver(), HwImsManager.isDualImsAvailable() ? HW_VOLTE_USER_SWITCH_DUALIMS[this.mHwRilReferenceInstanceId.intValue()] : HW_VOLTE_USER_SWITCH, on ? 1 : 0);
...
*/
    ...
    public void handleImsSwitch(boolean modemImsStatus) {
        ...
        int subId = HwTelephonyManagerInner.getDefault().getDefault4GSlotId();
        if (this.mHwRilReferenceInstanceId == null || !(HwImsManager.isDualImsAvailable() || this.mHwRilReferenceInstanceId.intValue() == subId)) {
    ...
    private void setImsSwitch(final boolean on, boolean isSaveDB) {
        if (this.mHwRilReferenceInstanceId == null || !(HwImsManager.isDualImsAvailable() || this.mHwRilReferenceInstanceId.intValue() == HwTelephonyManagerInner.getDefault().getDefault4GSlotId())) {
...
*/
    ...
    public boolean getImsSwitch() {
        return HwImsManager.isEnhanced4gLteModeSettingEnabledByUser(this.mContext, this.mHwRilReferenceInstanceId.intValue());
    }
    ...
    public void handleUnsolicitedRadioStateChanged(boolean on, Context context) {
        ...
        if (!HwModemCapability.isCapabilitySupport(9)) {
            ...
            if ((!on || !FEATURE_HW_VOLTE_ON) && !FEATURE_HW_VOWIFI_ON) {
                ...
                boolean isSupportVolte = HwImsManager.isVolteEnabledByPlatform(context, this.mHwRilReferenceInstanceId.intValue());
...
*/
    ...
    public void existNetworkInfo(java.lang.String r6) {
        /*
        r5 = this;
        r2 = 3;
        r4 = 0;
        r1 = 3034; // 0xbda float:4.252E-42 double:1.499E-320;
        r5.unsljLog(r1);
    ...
    L_0x000f:
        r1 = "RILJ-HwRILReferenceImpl";
        r2 = "plmn para error! break";
        android.telephony.Rlog.d(r1, r2);
        return;
    L_0x0019:
        r1 = r6.substring(r4, r2);
        r5.mcc_operator = r1;
        r1 = "RILJ-HwRILReferenceImpl";
        r2 = new java.lang.StringBuilder;
        r2.<init>();
        r3 = "recieved RIL_UNSOL_HW_EXIST_NETWORK_INFO with mcc_operator =";
        r2 = r2.append(r3);
        r3 = r5.mcc_operator;
        r2 = r2.append(r3);
        r3 = "and mMcc =";
    ...
    L_0x006b:
        return;
    L_0x006c:
        r1 = r5.shouldReportRoamingPlusInfo;
        if (r1 == 0) goto L_0x00a6;
    L_0x0070:
        r0 = new android.content.Intent;
        r0.<init>();
        r1 = "android.intent.action.HW_EXIST_NETWORK_INFO";
        r0.setAction(r1);
        r1 = "current_mcc";
        r2 = r5.mcc_operator;
        r0.putExtra(r1, r2);
        r1 = r5.existNetworkContext;
        r1.sendBroadcast(r0);
        r1 = "RILJ-HwRILReferenceImpl";
        r2 = new java.lang.StringBuilder;
        r2.<init>();
        r3 = "sendBroadcast:ACTION_HW_EXIST_NETWORK_INFO_ROAMING_PLUS with extra: mcc_operator=";
        r2 = r2.append(r3);
        r3 = r5.mcc_operator;
        r2 = r2.append(r3);
        r2 = r2.toString();
        android.telephony.Rlog.d(r1, r2);
        r5.shouldReportRoamingPlusInfo = r4;
    L_0x00a6:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.HwRILReferenceImpl.existNetworkInfo(java.lang.String):void");
    }
